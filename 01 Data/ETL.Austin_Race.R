...
# Change file_path to where your PreETL.Austin_Race.csv file is located.
file_path = "../../../CSVs/PreETL.Austin_Race.csv"
df <- readr::read_csv(file_path)
names(df)

measures <- c("B02001_001", "B02001_002", "B02001_003", "B02001_004", "B02001_005", "B02001_006", "B02001_007")
